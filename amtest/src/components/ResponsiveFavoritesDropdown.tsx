...
import styles from '../styles/ResponsiveFavoritesDropdown.module.css';
import { FiBookmark, FiTrash } from 'react-icons/fi';

const ResponsiveFavoritesDropdown: React.FC = () => {
    ...
    return (
        <div className={`${styles.responsiveFavoritesDropdown} ${isOpen ? styles.open : ''}`}>
...
export default ResponsiveFavoritesDropdown;
